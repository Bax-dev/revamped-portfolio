  ...
  projects: [
    {
      ...
      description:
        "A comprehensive IoT solution for industrial equipment monitoring with real-time data collection, predictive maintenance alerts, and cloud-based analytics dashboard.",
      image: "/ecommerce-website-mockup.png",
      tech: ["Node.js", "Python", "MQTT", "PostgreSQL", "React", "Arduino"],
      demo: "https://demo.example.com",
      github: "https://github.com/username/iot-monitoring",
    },
    {
      title: "Automated Warehouse Management API",
      description:
        "RESTful API system for warehouse automation with inventory tracking, robotic integration, and real-time order processing capabilities.",
      image: "/task-management-dashboard.png",
      tech: ["Python", "FastAPI", "PostgreSQL", "Redis", "Docker", "ROS"],
      demo: "https://demo.example.com",
      github: "https://github.com/username/warehouse-api",
    },
    {
      title: "Smart Home Automation Hub",
      description:
        "Centralized home automation system with voice control, mobile app integration, and custom hardware for controlling lights, climate, and security.",
      image: "/ai-content-generator-interface.png",
      tech: ["Node.js", "React Native", "Raspberry Pi", "MQTT", "MongoDB"],
      demo: "https://demo.example.com",
    ...
    },
    {
      ...
      description:
        "Precision robotic arm control system with computer vision integration, path planning algorithms, and real-time motion control.",
      image: "/weather-dashboard-app.png",
      tech: ["Python", "OpenCV", "ROS", "Arduino", "C++", "WebSocket"],
      demo: "https://demo.example.com",
    ...
    },
    {
      ...
      description:
        "Scalable microservices architecture for e-commerce platform with payment processing, inventory management, and order fulfillment APIs.",
    ...
    },
    {
      ...
      description:
        "Distributed sensor network for environmental monitoring with data aggregation, analysis, and real-time alerting system.",
      image: "/social-media-analytics-dashboard.png",
      tech: ["Python", "InfluxDB", "Grafana", "LoRaWAN", "Raspberry Pi"],
      demo: "https://demo.example.com",
